...
- [X] Corrigir o fato que registros de coleta de sessões diferentes estão sendo considerados como fontes diferentes no grafana (reconhece hosts diferentesa cada ciclo de vida dos containers)
